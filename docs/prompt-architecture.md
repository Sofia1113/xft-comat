A clean, professional software architecture diagram, rendered in Anthropic Claude's official brand UI style.

STYLE (strict):
- Background: warm off-white cream (#F0EEE6).
- Primary accent: terracotta clay orange (#D97757) for the main plugin container and key arrows.
- Secondary tones: soft warm grey (#BFBAAE), muted dark slate (#3D3D3A) for text, gentle sand beige (#E8E4D8) for card fills.
- Boxes: rounded rectangles, soft thin borders, very subtle drop shadow, generous padding, flat minimal design, lots of breathing whitespace.
- Typography: clean modern sans-serif for labels, a serif display font for the main title. Labels short and crisp.
- Overall mood: calm, editorial, premium, uncluttered. NOT neon, NOT dark-mode, NOT cyberpunk.

CONTENT — a layered diagram titled "xft-comat Plugin Architecture":

Top title bar: "xft-comat Plugin Architecture"
